<template>
    <main class="mt-10 container mx-auto px-8">
      <header class="z-10 mb-10">
        <h1 class="text-5xl font-bold text-white">Privacy Policy</h1>
      </header>
  
      <section class="min-h-screen flex flex-col items-center justify-center text-white pb-4">
        <div class="bg-gradient-to-r from-purple-900 to-blue-900 p-8 rounded-lg shadow-lg">
          <p class="mb-6">
          ...
          <p class="mb-6">
            We implement appropriate security measures to protect your personal information. However, please note that no method of transmission over the internet or method of electronic storage is completely secure.
          </p>
